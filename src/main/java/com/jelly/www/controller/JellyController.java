...
public class JellyController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (page == null || page.equals("home")) {
			...
			action = new StyleListAction(); // 스타일 페이지 처리
		...
		} else if (page.equals("buyBid")) { // 판매 / 구매 입찰 페이지 처리
			action = new BuyBidpriceAction();
		...
		} else if (page.equals("sellBid")) { // 판매 / 구매 입찰 페이지 처리
			action = new SellBidpriceAction();
